...
func (x *InstallSnapshotRequest) Reset() {
	*x = InstallSnapshotRequest{}
	mi := &file_rpc_raft_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstallSnapshotRequest) Descriptor() ([]byte, []int) {
	return file_rpc_raft_proto_rawDescGZIP(), []int{5}
}
...
func (x *InstallSnapshotResponse) Reset() {
	*x = InstallSnapshotResponse{}
	mi := &file_rpc_raft_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstallSnapshotResponse) Descriptor() ([]byte, []int) {
	return file_rpc_raft_proto_rawDescGZIP(), []int{6}
}
...
const file_rpc_raft_proto_rawDesc = "" +
	"\n" +
	"\x0erpc/raft.proto\x12\x06raftpb\"N\n" +
	"\bLogEntry\x12\x12\n" +
	...
	"\x0fInstallSnapshot\x12\x1e.raftpb.InstallSnapshotRequest\x1a\x1f.raftpb.InstallSnapshotResponseB.Z,github.com/Abdullah-A-Qazi/RaftDB/rpc/raftpbb\x06proto3"
...
var file_rpc_raft_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
